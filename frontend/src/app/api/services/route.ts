...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      console.error(`[API Route] /api/services: Backend error (${response.status}):`, errorText);
    ...
    console.log('[API Route] /api/services: Response received from backend');
    ...
    if (data) {
      ...
      console.log('[API Route] /api/services: Returning formatted response');
      return NextResponse.json(formattedResponse);
    } else {
      console.error('[API Route] /api/services: Empty response from backend');
      return NextResponse.json({ 
    ...
    console.error('[API Route] /api/services: Exception occurred:', error.message);
    return NextResponse.json({ 
